...
try:
    ...
    print("Warning: CatBoost not installed. Install with: pip install catboost --break-system-packages")
...
try:
    ...
    print("Warning: LightGBM not installed. Install with: pip install lightgbm --break-system-packages")
...
try:
    ...
    print("Warning: XGBoost not installed. Install with: pip install xgboost --break-system-packages")
...
class CalibratedBoostingModel(SupervisedRationaleModel):
    ...
    def fit(
        ...
        if verbose:
            print(f"Training {self.base_model_type.upper()} for '{self.rationale}': "
