...
try:
    ...
    print("Warning: GPyTorch not installed. Install with: pip install gpytorch --break-system-packages")
...
class GPModel(BaseRationaleModel):
    ...
    def fit(
        ...
        if verbose:
            print(f"Training {self.gp_model_type.upper()} for '{self.rationale}': "
    ...
    def save(self, filepath: str):
        ...
        save_dict = {
            ...
            'likelihood_state': self.likelihood.state_dict() if self.likelihood else None,
            'hyperparameters': {
    ...
    def load(cls, filepath: str, device: str = None):
        ...
        # Simplified for now
        print("Warning: Full GP model loading requires retraining with same inducing points")
